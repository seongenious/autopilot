"""Perspective view pretraining script.

Pretrains panoptic segmentation (+ depth estimation in future)
on 2D perspective images before BEV training.
"""
...
@hydra.main(version_base=None, config_path="../../configs", config_name="pretrain/panoptic")
