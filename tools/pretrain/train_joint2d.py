"""Joint Panoptic + Depth pretraining script.

Trains panoptic segmentation and depth estimation jointly
with shared backbone and neck.
"""
...
from autopilot.engine import Runner, HookCallback, build_hooks
...
def print_model_params(model: nn.Module) -> None:
    ...
    components = [
        ...
        ("neck", model.neck),
        ("sem_context", model.sem_context),
        ("inst_context", model.inst_context),
        ("depth_context", model.depth_context),
        ("panoptic_head", model.panoptic_head),
...
@hydra.main(version_base=None, config_path="../../configs", config_name="pretrain/joint2d")
